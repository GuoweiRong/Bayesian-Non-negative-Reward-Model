...
class ScriptArguments:
    ...
    noise_ratio:Optional[float] = field(default=0.0)
...
# Load datasets
train_dataset, eval_dataset = load_train_eval_dataset(script_args.dataset, tokenizer, mode=script_args.dataset_mode,Label_noise=script_args.Label_noise ,noise_ratio=script_args.noise_ratio,size=100 if script_args.debug else None)
...
trainer_params = {
    ...
    'layer_type': model_params['vhead_layer_type'],
    'num_neurons': model_params['vhead_num_neurons'],
    'num_layers': model_params['vhead_num_layers'],
    }
}
