    ...
    def __init__(
        ...
        if not is_peft_available() and peft_config is not None:
            ...
            if not isinstance(model, PeftModel):
                ...
                # print("v_head in model            :", hasattr(model, "v_head"))
                # print("v_head in model.base_model :", hasattr(model.base_model, "v_head"))
                # print("v_head in base_model.model :", hasattr(model.base_model.model, "v_head"))
                # print('*********************')
                # import pdb
                # pdb.set_trace()
